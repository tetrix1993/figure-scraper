...
class Ensky(Website):
    ...
    product_url_template = page_prefix + '/products/%s'
    ...
    def run(cls):
        ...
        while True:
            ...
            print('[INFO] Product Page URL is in the format: https://www.enskyshop.com/products/{product_id}')
    ...
    def process_product_page(cls, product_id, use_jan=False):
        ...
        try:
            ...
            divs = soup.find_all('div', class_='subphotoimg')
            if len(divs) == 0:
    ...
    def get_jan_code(soup):
        result = ''
        span = soup.find('span', id='product_code_default')
        if span:
